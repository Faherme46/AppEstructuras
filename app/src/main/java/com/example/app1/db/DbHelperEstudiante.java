...
public class DbHelperEstudiante extends SQLiteOpenHelper {
    private static final int DATABASE_V=1;

    public static final String Tabla_Estudiantes ="TablaEstudiantes";

    public DbHelperEstudiante(@Nullable Context context, @Nullable String name, int version) {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        sqLiteDatabase.execSQL("CREATE TABLE "+ Tabla_Estudiantes +" ( " +
